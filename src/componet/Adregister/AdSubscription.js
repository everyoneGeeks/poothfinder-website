...
import Register from "../Adregister/AdRegister";
...
handleSubmit(event,data){
    ...
    event.preventDefault();
      ...
      const register = axios.post("https://00a384-poothfinder-graduate.magdsoft.com/api/registeBoothOwner",{
      ...
      .then(result => {
        if(result.data.message){
         ...
         this.props.history.push("/advertiser/login");
...
export default withRouter(withStyles(useStyles)(AdSubscription));
