 ...
 <h3 style={{float:"right",marginTop:20}}>{this.props.data.boothBoutique.name_ar}</h3>
    ...
    <tbody>
        <tr>
            ...
            <td style={{width: "204px",textAlign:"center"}}>{this.props.data.boothBoutique.name_ar}</td>
        </tr>
        <tr>
            <td style={{fontSize: "21px"}}>االمساحة</td>
            <td style={{width: "204px",textAlign:"center"}}> {this.props.data.boothBoutique.area}</td>
        </tr>
        
                <tr>
            <td style={{fontSize: "21px"}}>السعر </td>
            <td style={{width: "204px",textAlign:"center"}}> {this.props.data.price}</td>
        </tr>
        
        
                        <tr>
            <td style={{fontSize: "21px"}}>المدة  </td>
            <td style={{width: "204px",textAlign:"center"}}> {this.props.data.starts_from}  {this.props.data.ends_at}</td>
        </tr>
        
          <tr>
                    <td style={{fontSize: "21px"}}>الدفع   </td>
            <td style={{width: "204px",textAlign:"center"}}> {this.props.data.payment_type}</td>
        </tr>
    </tbody>
</table>
</Col>
