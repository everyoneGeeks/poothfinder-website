 ...
 class Statics extends React.Component {
  ...
  async  componentDidMount(){
    ...
    const auth=JSON.parse(Cookies.get('auth'));   
      ...
      const booths =axios.post("https://00a384-poothfinder-graduate.magdsoft.com/api/reservationsList",{
...
<Header />
  ...
  <Col xs="12"  lg="12" style={{marginTop:"10px"}}>
        <h3  style={{float:"right"}} >تقارير ماليه</h3>
        </Col>
  <Col lg={3}>
...
export default withStyles(useStyles)(Statics);